...
public class SalesItemTest
{
    ...
    {
        SalesItem salesIte1 = new SalesItem("xyz", 100);
        assertEquals(false, salesIte1.addComment("youssef", "hello", 6));
        assertEquals(false, salesIte1.addComment("Ibrahim", "Hi", 0));
    }

    @Test
    public void testFindMostHelpfulComment()
    {
        SalesItem salesIte1 = new SalesItem("ber", 140);
        assertEquals(true, salesIte1.addComment("david", "hmm", 5));
        assertEquals(false, salesIte1.addComment("beckam", "football", 8));
        assertEquals(true, salesIte1.addComment("ronaldo", "barcelona", 4));
        ...
        assertEquals("david", comment1.getAuthor());
