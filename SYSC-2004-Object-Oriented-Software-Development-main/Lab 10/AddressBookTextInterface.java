...
public class AddressBookTextInterface
{
    ...
    private void remove()
    {
        ...
        {
            System.out.println("NoMatchingDetailsException caught");
    ...
    private void change()
    {
        System.out.println("Type the old key of the entry");
        ...
        {
            System.out.println("NoMatchingDetailsException catched");
            System.out.println(e.toString());
        }
    }
}
